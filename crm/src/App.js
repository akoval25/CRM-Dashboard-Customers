...
function App() {
  ...
  // }, []);
    ...
    useEffect(() => {
      ...
      const mainContainerCustomers = document.querySelector('.main_container-customers');
      ...
      const handleClick = (event) => {
        ...
        if (hasCustomers) {
          if (mainContainerElse) mainContainerElse.style.display = 'none';
          if (mainContainerCustomers) mainContainerCustomers.style.display = 'block';
        } else {
          if (mainContainerElse) mainContainerElse.style.display = 'block';
          if (mainContainerCustomers) mainContainerCustomers.style.display = 'none';
        }
      };
  ...
  <path d="M6 12L10 8L6 4" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <div className="user">
          <img src={user} alt="user" width="42px" height="42px"/>
          <div className="user-data">
            <p className="user-data-name">Evano</p>
            <p className="user-data-position">Project Manager</p>
          </div>
        </div>
